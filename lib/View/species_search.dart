...
import 'package:green_house/model/species_search_model.dart';
...
// build body
              ...
              child: Container(
                ...
                child: ListView.builder(
                  itemBuilder: (context, index) => _buildlistitem(
                      plantname: "Fat Cactus",
                      plantimage: imageslist[index].image,
                      plantdescription:
            ...
            Column(
              ...
              children: [
                ...
                Container(
                  width: 200,
                  height: 40,
                  child: _listplanttext(
                      text: plantdescription, mycolor: Colors.black87),
                )
              ],
            ),
          ],
  ...
  Widget _listplanttext({required String text, required Color mycolor}) {
    return Text(
      text,
      style:
          TextStyle(fontWeight: FontWeight.w500, fontSize: 15, color: mycolor),
